...
Ashwagandha, Kreatin, Bryan Johnson Blueprint, NMN/NR, Shilajit, Timing-Optimierung, Antagonismen (Zink vs. Magnesium, Vit C vs. Kupfer).

## Notion-Docs die daraus entstanden sind

`Supplement Stack & Biohacking`, `Neurotransmitter Network`, `Peptide Protokolle`, `Energie-Stabilität`, `Augenringe & Äußerlichkeiten`, `Haltung & Mobilität`, `Theoretischer Full Stack`.

## Quelle

5 Claude-Chats vom 2026-04-06.
