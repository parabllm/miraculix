# AGENTS.md - Miraculix Boot-Instruction

Dieses File wird von Codex automatisch beim Start im Vault-Root geladen.
Für Codex Desktop: als Always-On-Kontext verweisen.
...
- Sichere Schreibmethoden in Reihenfolge der Praeferenz:
  ...
  - Codex Write/Edit (Self-Test SAUBER, Hex-Verify trotzdem Pflicht)
...
Wenn unter `C:\Users\deniz\Documents\notion\` oder `C:\Users\deniz\Documents\Codex\` Daten liegen und der Vault weitgehend leer ist:
...
- Nie `_meta/` oder `AGENTS.md` ändern ohne explizite Anweisung
...
### Am PC (Desktop)
Deniz labbert im Miraculix-Chat oder Projekt-Chat → Codex schreibt live in die richtigen Stellen.
