...
typ: kontakt
name: "Florian Meyer"
aliase: ["Florian Meyer", "Florian M"]
gruppen: ["extern"]
...
Interview-Kandidat [[bachelor-thesis]]. Extern via LinkedIn. Noch nicht angefragt.

## Anfrage-Template

Hallo Florian,

ich bin Deniz Özbek, Student an der HdWM Mannheim. Ich schreibe meine Bachelorarbeit darüber, wie KI im Recruiting strategisch gestaltet werden muss, um sowohl betriebliche Effizienz als auch die Anforderungen des EU AI Act zu erfüllen.

Dein Profil auf LinkedIn hat mich aufmerksam gemacht [hier konkret ergänzen nach Profil-Check]. Ich würde mich freuen, deine Perspektive in einem Gespräch von etwa einer Stunde per Teams einzuholen, auf Wunsch anonym.
